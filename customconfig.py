...
_C.DATASET.DATAROOT = '//content/drive/MyDrive/images'       # the path of images folder
_C.DATASET.LABELROOT = '/content/drive/MyDrive/ll_seg_annotations'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/content/drive/MyDrive/masks_23_04_'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/content/drive/MyDrive/masks_23_04'               # the path of ll_seg_annotations folder
